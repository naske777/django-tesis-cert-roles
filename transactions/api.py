...
class TransactionViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Combina los datos de la wallet y los de la transacción creada en un solo objeto de respuesta
        response_data = {
            'transaction': serializer.data,
            'wallet': wallet_serializer.data
        }

        # Devuelve los datos combinados con el estado HTTP 201 Created
